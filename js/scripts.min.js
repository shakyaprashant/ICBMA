(function (a) {
  a(document).ready(function () {
    ...
    768 > a(window).width() &&
      (a(".animated").removeClass("animated").removeClass("hiding"),
      a(".stat span").removeClass("timer"),
      a(".timeslot-label").addClass("stick-label"));
    512 > a(window).height() &&
      a("#bottom-navlinks")
        .removeClass("bottom-navlinks")
        .addClass("bottom-navlinks-small");
    100 <= a(window).scrollTop() &&
      (a("#top-header").addClass("after-scroll"));
    a(window).scroll(function () {
      ...
      100 <= b
        ? (d.addClass("after-scroll"))
        : (d.removeClass("after-scroll"));
      b >= a(".top-section").height() && 767 < a(window).width()
        ? e.removeClass("right-nav-button-hidden")
        : b < a(".top-section").height() &&
          767 < a(window).width() &&
          e.addClass("right-nav-button-hidden");
      a(".slot").each(function () {
        var d = a(this).offset().top - b,
          e = f + a(this).find(".slot-title").height();
        d <= e &&
          0 <= d &&
          a(".track-header.sticky")
            .find(".slot-detail")
            .html(a(this).data("slotDetail"));
      });
    });
    a(window).resize(function () {
      1500 < a(window).width()
        ? a(".effect-wrapper").addClass("col-lg-3")
        : a(".effect-wrapper").removeClass("col-lg-3");
      768 > a(window).width()
        ? (a(".same-height").css("height", "100%"),
          a(".timeslot-label").addClass("stick-label"))
        : (a(".timeslot-label").removeClass("stick-label"),
          c.hasClass("st-menu-open") &&
            (c.removeClass("st-menu-open"), a("body").css("overflow", "auto")),
          equalheight(".same-height"));
      512 > a(window).height()
        ? (a(".st-menu").addClass("scrollable"),
          a("#bottom-navlinks")
            .removeClass("bottom-navlinks")
            .addClass("bottom-navlinks-small"))
        : (a(".st-menu").removeClass("scrollable"),
          a("#bottom-navlinks")
    ...
    a(function () {
      a("a[href*=#]:not([href=#])").click(function () {
        if (
          ...
          if (b.length)
            return (
              a("html,body").animate({ scrollTop: b.offset().top }, 1e3), !1
            );
        }
      });
    });
    ...
    a(function () {
      -1 < window.location.href.indexOf("schedule") &&
    ...
    a(function () {
      ...
      for (e = f.length; c < e; c++)
        (d = f[c]),
          (b = d.offsetLeft + d.offsetTop),
          (b /= 1e3),
          a(d).css("transition-delay", "" + 0.47 * b + "s"),
          a(d).css("transition-duration", "0.2s");
    });
    a(".appear-animation-trigger").appear(function () {
      setTimeout(function () {
        a(".appear-animation-trigger")
          .parent("div")
    ...
    a(".track-header").each(function () {
      for (
        var b = a(this).closest(".schedule-table").find(".slot").first(), d;
        void 0 === d;

      )
        (d = b.data("slotDetail")), (b = b.next());
    ...
    a(".slider").each(function () {
      a(this)
        ...
        .removeClass("hidden");
      1 < a(this).find(".slider-item").length &&
        a(this)
    ...
    a(".slider-next-item").click(function () {
      ...
      d.length
        ? (d.addClass("slider-current-item").removeClass("hidden"),
          b
  ...
  if ("undefined" !== typeof googleMaps) {
    ...
    google.maps.event.addDomListener(window, "load", function () {
        ...
        x.route(
          {
            ...
            travelMode: google.maps.TravelMode[f],
          },
          function (d, e) {
            if (e == google.maps.DirectionsStatus.OK) {
              ...
              g =
                g.substring(0, g.indexOf("#") + 1) + "icon-" + f.toLowerCase();
              a("#mode-icon use").attr("xlink:href", g);
            } else
              e != google.maps.DirectionsStatus.OK && "DRIVING" != f
                ? m(k, "DRIVING")
                : ((g = p.getPath()),
                  g.push(k),
                  g.push(eventPlace),
                  ...
                  a("#distance").text(g + " km"),
                  a("#estimateTime").text(""),
                  a("#find-flight").removeClass("hidden"),
                  a("#mode").addClass("hidden"));
          }
        );
        d();
        ...
        r.geocode({ latLng: b }, function (b, c) {
          c == google.maps.GeocoderStatus.OK &&
            ...
            a.each(b[1].address_components, function (b, c) {
              if ("locality" == c.types[0])
                return a("#result-name").text(c.long_name), !1;
            });
        });
      }
          ...
          google.maps.event.addListener(q, "place_changed", function () {
            ...
            if ("undefined" != a.geometry && a.geometry) {
              ...
              a.address_components &&
                (b = [
                  (a.address_components[0] &&
                    a.address_components[0].short_name) ||
                    "",
                  (a.address_components[1] &&
                    a.address_components[1].short_name) ||
                    "",
                  (a.address_components[2] &&
                    a.address_components[2].short_name) ||
                    "",
                ].join(" "));
              r.geocode({ address: b }, function (a, b) {
                b == google.maps.GeocoderStatus.OK
                  ? ((h = a[0].geometry.location), m(h, "TRANSIT"))
                  : alert(
      ...
      a("#direction-cancel").click(function () {
        ...
        c.panTo(eventPlace);
        768 > a(window).width()
          ? c.setCenter(mobileCenterMap)
          : c.setCenter(centerMap);
        b(eventPlace);
        v(5);
        a("#find-way h3").removeClass("fadeOutDown").addClass("fadeInUp");
      });
      "undefined" !== typeof autoDirectionEnabled &&
        1 == autoDirectionEnabled &&
        u();
    });
  }
})(jQuery);
